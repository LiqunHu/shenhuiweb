        ...
        <div class="modal-content">
          ...
          <form @submit.prevent="addOp" id="formA">
            <div class="modal-body">
              <div class="form-group">
                <label>
                  <span class="table-required">*</span>标题
                </label>
              ...
              <div class="form-group">
                <label>
                  <span class="table-required">*</span>作者
                </label>
...
export default {
  ...
  mounted: async function() {
    ...
    common.initSelect2($("#article_year"), retData.YEARSINFO);
    initTable();
  },
  methods: {
    addM: function(event) {
